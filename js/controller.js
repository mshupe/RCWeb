...
function RequestPasswordReset() {
    ...
    $.ajax({
        url: "https://raincommander.com/Controller/wsCmd.asmx/RequestPasswordReset",
        cache: false,
        type: "POST",
        dataType: "json",
...
function SaveAccountAddress() {
    ...
    $.ajax({
        url: "https://raincommander.com/Controller/wsCmd.asmx/SaveAddress",
        cache: false,
        type: "POST",
        dataType: "json",
...
function Register() {
    ...
    $.ajax({
        url: "https://raincommander.com/Controller/wsCmd.asmx/AddNewUser",
        cache: false,
        type: "POST",
        dataType: "json",
        data: sRegisterData,
